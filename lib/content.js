  ...
  strings: {
    ...
    ru: {
      ...
      business: {
        ...
        subtitle: "Офис, магазин, кафе или склад. Расскажите, что нужно подключить — подберём решение под ваши задачи.",
        cta: "Оставить заявку для бизнеса",
        note: "Менеджер перезвонит и уточнит детали.",
        phoneLead: "Или позвоните:",
        listTitle: "Подключаем",
        items: ["Офисы", "Магазины и кафе", "Склады и производство", "Несколько точек в одной сети"]
      },
      chat: {
        hint: "Нужна помощь?",
        open: "Открыть чат",
        close: "Закрыть чат",
        title: "Помощник CITYNET",
        subtitle: "Онлайн-помощник",
        greet: "Привет! Я помощник CITYNET. Подберу тариф и проверю, можно ли подключить ваш адрес.",
        askGoal: "Для чего вам интернет?",
        goals: [
          { id: "work", label: "Работа и учёба", tariff: "smart" },
          { id: "stream", label: "Кино и игры", tariff: "pro" },
          { id: "family", label: "Для всей семьи", tariff: "pro" },
          { id: "business", label: "Для бизнеса" }
        ],
        businessAsk: "Для бизнеса условия подбираем индивидуально. Напишите адрес объекта и что нужно подключить: офис, магазин, склад.",
        businessThanks: "Принял, передам менеджеру.",
        businessDone: "Готово, заявка для бизнеса отправлена. Менеджер свяжется с вами и уточнит детали.",
        recommend: "Вам подойдёт {name}: {speed} Мбит/с, {price} сум в месяц.",
        askAddress: "Напишите адрес или название ЖК — проверю, работает ли у вас CITYNET.",
        addrFound: "Отлично, CITYNET уже работает в «{object}».",
        addrUnknown: "Не нашёл этот адрес в списке, но это не значит, что подключения нет — специалист проверит его вручную.",
        askName: "Как вас зовут?",
        badName: "Введите имя, минимум 2 символа.",
        askPhone: "{name}, оставьте номер телефона — оператор перезвонит и оформит подключение.",
        badPhone: "Нужны 9 цифр после +998, например 90 123 45 67.",
        phoneNote: "Отправляя номер, вы соглашаетесь с",
        done: "Готово, заявка отправлена. Оператор свяжется с вами.",
        error: "Не удалось отправить заявку. Попробуйте ещё раз или заполните форму на странице.",
        openForm: "Заполнить форму самому",
        restart: "Начать заново",
        send: "Отправить",
        addressPlaceholder: "Адрес или ЖК",
      ...
      form: {
        ...
        sending: "Отправляем…",
        businessBadge: "Заявка для бизнеса",
        businessSwitch: "Нужен домашний интернет",
    ...
    uz: {
      ...
      business: {
        title: "Biznes uchun internet",
        subtitle: "Ofis, doʻkon, kafe yoki ombor. Nimani ulash kerakligini yozing — vazifalaringizga mos yechim tanlaymiz.",
        cta: "Biznes uchun ariza qoldirish",
        note: "Menejer qoʻngʻiroq qilib, tafsilotlarni aniqlaydi.",
        phoneLead: "Yoki qoʻngʻiroq qiling:",
        listTitle: "Ulaymiz",
        items: ["Ofislar", "Doʻkon va kafelar", "Ombor va ishlab chiqarish", "Bir tarmoqdagi bir nechta nuqta"]
      },
      chat: {
        hint: "Yordam kerakmi?",
        open: "Chatni ochish",
        close: "Chatni yopish",
        title: "CITYNET yordamchisi",
        subtitle: "Onlayn yordamchi",
        greet: "Salom! Men CITYNET yordamchisiman. Tarif tanlashga va manzilingizga ulanish mumkinligini tekshirishga yordam beraman.",
        askGoal: "Internet sizga nima uchun kerak?",
        goals: [
          { id: "work", label: "Ish va oʻqish", tariff: "smart" },
          { id: "stream", label: "Kino va oʻyinlar", tariff: "pro" },
          { id: "family", label: "Butun oila uchun", tariff: "pro" },
          { id: "business", label: "Biznes uchun" }
        ],
        businessAsk: "Biznes uchun shartlar individual tanlanadi. Obyekt manzilini va nimani ulash kerakligini yozing: ofis, doʻkon, ombor.",
        businessThanks: "Qabul qildim, menejerga yetkazaman.",
        businessDone: "Tayyor, biznes uchun ariza yuborildi. Menejer siz bilan bogʻlanib, tafsilotlarni aniqlaydi.",
        recommend: "Sizga {name} mos keladi: {speed} Mbit/s, oyiga {price} soʻm.",
        askAddress: "Manzilni yoki turar-joy majmuasi nomini yozing — CITYNET ishlashini tekshiraman.",
        addrFound: "Ajoyib, CITYNET «{object}» da allaqachon ishlaydi.",
        addrUnknown: "Bu manzilni roʻyxatdan topolmadim, lekin bu ulanish yoʻq degani emas — mutaxassis uni qoʻlda tekshiradi.",
        askName: "Ismingiz nima?",
        badName: "Ismni kiriting, kamida 2 belgi.",
        askPhone: "{name}, telefon raqamingizni qoldiring — operator qoʻngʻiroq qilib, ulanishni rasmiylashtiradi.",
        badPhone: "+998 dan keyin 9 ta raqam kerak, masalan: 90 123 45 67.",
        phoneNote: "Raqamni yuborish orqali quyidagiga rozilik bildirasiz:",
        done: "Tayyor, ariza yuborildi. Operator siz bilan bogʻlanadi.",
        error: "Arizani yuborib boʻlmadi. Qayta urinib koʻring yoki sahifadagi shaklni toʻldiring.",
        openForm: "Shaklni oʻzim toʻldiraman",
        restart: "Boshidan boshlash",
        send: "Yuborish",
        addressPlaceholder: "Manzil yoki majmua",
      ...
      form: {
        ...
        businessBadge: "Biznes uchun ariza",
        businessSwitch: "Uy interneti kerak",
    ...
    en: {
      ...
      business: {
        ...
        subtitle: "Office, shop, café or warehouse. Tell us what needs connecting and we'll suggest a solution for your tasks.",
        cta: "Request business connection",
        note: "A manager will call and clarify the details.",
        phoneLead: "Or call:",
        listTitle: "We connect",
        items: ["Offices", "Shops and cafés", "Warehouses and production", "Several locations in one network"]
      },
      chat: {
        hint: "Need help?",
        open: "Open chat",
        close: "Close chat",
        title: "CITYNET assistant",
        subtitle: "Online assistant",
        greet: "Hi! I'm the CITYNET assistant. I'll help you pick a plan and check whether we can connect your address.",
        askGoal: "What do you need internet for?",
        goals: [
          { id: "work", label: "Work and study", tariff: "smart" },
          { id: "stream", label: "Movies and games", tariff: "pro" },
          { id: "family", label: "The whole family", tariff: "pro" },
          { id: "business", label: "Business" }
        ],
        businessAsk: "For business we work out the terms individually. Tell us the address and what needs connecting: office, shop, warehouse.",
        businessThanks: "Got it, I'll pass this to a manager.",
        businessDone: "Done, your business request is sent. A manager will contact you to clarify the details.",
        recommend: "{name} suits you best: {speed} Mbps, {price} UZS a month.",
        askAddress: "Type your address or the name of your residential complex — I'll check if CITYNET is available.",
        addrFound: "Great, CITYNET already works in “{object}”.",
        addrUnknown: "I couldn't find this address in the list, but that doesn't mean we can't connect you — a specialist will check it manually.",
        askName: "What's your name?",
        badName: "Enter your name, at least 2 characters.",
        askPhone: "{name}, leave your phone number — an operator will call you and set up the connection.",
        badPhone: "We need 9 digits after +998, for example 90 123 45 67.",
        phoneNote: "By sending your number you agree to the",
        done: "Done, your request is sent. An operator will contact you.",
        error: "Couldn't send your request. Try again or fill in the form on the page.",
        openForm: "Fill in the form myself",
        restart: "Start over",
        send: "Send",
        addressPlaceholder: "Address or complex",
      ...
      form: {
        ...
        submit: "Send request",
        sending: "Sending…",
        businessBadge: "Business request",
        businessSwitch: "I need home internet",
