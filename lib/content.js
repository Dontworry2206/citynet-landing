  ...
  strings: {
    ...
    ru: {
      ...
      chat: {
        ...
        businessRoute: "Для бизнеса условия подбираем индивидуально, готового тарифа нет. Оставьте заявку — менеджер уточнит задачи и предложит решение.",
        businessCta: "Перейти к заявке",
    ...
    uz: {
      ...
      chat: {
        ...
        businessRoute: "Biznes uchun shartlar individual tanlanadi, tayyor tarif yoʻq. Ariza qoldiring — menejer vazifalaringizni aniqlab, yechim taklif qiladi.",
        businessCta: "Arizaga oʻtish",
    ...
    en: {
      ...
      chat: {
        ...
        businessRoute: "For business we work out the terms individually, there is no ready-made plan. Leave a request and a manager will clarify your needs and propose a solution.",
        businessCta: "Go to the request",
